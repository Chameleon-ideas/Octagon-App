...
class CommonLoginButton extends StatefulWidget {
  ...
  bool isLogin = false;
  CommonLoginButton({super.key,required this.applePress,/*required this.facebookPress,*/required this.googlePress, this.isLogin = false});
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                width: 23.5.w,
                height: 0.70.w,
                color: widget.isLogin? whiteColor: dark,
              ),
              Text(
                "OR CONTINUE WITH",
                style: getNormalFontStyle(fontSize: 12.sp, fontWeight: FontWeight.w600, color: widget.isLogin? whiteColor: dark)
              ),
              Container(
