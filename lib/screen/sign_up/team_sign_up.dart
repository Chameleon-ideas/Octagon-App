...
/*
  ...
  */
  ...
  void initState() {
    ...
    //         otpVerifyBloc.otpVerify(OtpVerifyRequestModel(
    //           email: _emailController.text.trim(),///todo parth check this with api.
    //           otp: "123456",
    //         ));
    //         print(event.data);
    //       }
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        //     print(gender);
                        //     typeOfGender = (gender == Gender.Male) ? 1 : (gender == Gender.Female) ? 2 : 0;
                        //   },
                        //   equallyAligned: true,
