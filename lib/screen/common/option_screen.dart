                ...
                children: [
                      ...
                      icons: [
                        ...
                        AnimatedIconItem(
                          icon: Icon(
                            ...
                            color: postData!.isLikedByMe ? redColor : greyColor,
                            size: 30,
                          ),
                          onPressed: () {
                            if (onLikePress != null) {
                  ...
                  Visibility(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Share.share(
                            'check out this post:- https://octagonapp.com/post/${postData!.id}',
                            subject: 'Octagon');
                      },
                    ),
                  ),
