          ...
          builder: (context,_) {
            return RefreshIndicator(
              child: Visibility(
                ...
                replacement: isLoading? GestureDetector(
                  onTap: (){
                    getNotification();
                  },
                    child: SizedBox(
                ...
                Flexible(
                  child: RichText(text: TextSpan(
                      children: [
                        ...
                        TextSpan(text: "${notification.notification} ".capitalize!,
                            style: whiteColor14TextStyle),
                        TextSpan(text: (notification.createdAt ??
                            DateTime.now()).timeAgo(numericDates: false), style: greyColor14TextStyle)
                      ]
                  )),
                )
              ],
