...
import 'package:octagon/screen/score/score_screen.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            body: pages.elementAt(data),/*PageTransitionSwitcher(
              transitionBuilder: (
                  Widget child,
            ...
            //   },
            // ),
            bottomNavigationBar: _buildBottomBar(data),/*BottomAppBar(
              child: Row(
