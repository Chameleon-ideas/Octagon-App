...
const String getOtherUserDetailsUrl = "user-profile";///other user details
...
const String saveUserPostApiUrl = "save-post";///save to collection
const String userRemoveApiUrl = "user-remove";
const String reportUserPostApiUrl = "save-post-report";

const String createPostApiUrl = "save-user-post";///create post
const String deletePostApiUrl = "delete-user-post";///delete post

const String uploadFileApiUrl = "user-upload-file";

const String deleteCommentApiUrl = "delete-user-comment";///delete comment


const String followUserApiUrl = "set-user-followers";///follow unfollow
