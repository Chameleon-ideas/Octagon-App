...
BoxDecoration filledButtonDecoration = BoxDecoration(
...
//disable button
BoxDecoration basicButtonDecoration = BoxDecoration(
    borderRadius: BorderRadius.circular(10),
    color: darkGreyColor
);
...
BoxDecoration borderButtonDecoration = BoxDecoration(
    borderRadius: BorderRadius.circular(8),
   border: Border.all(color: borderButtonBorderColor, width: 1.5)
);

BoxDecoration borderButtonDarkDecoration = BoxDecoration(
    borderRadius: BorderRadius.circular(8),
...
BoxDecoration mainActionDecoration = BoxDecoration(
borderRadius: BorderRadius.circular(8),
border: Border.all(color: mainActionBorderColor, width: mainActionBorderWidth)
);
BoxDecoration mainActionDarkDecoration = BoxDecoration(backgroundBlendMode: BlendMode.difference,
    borderRadius: BorderRadius.circular(8),
...
///BlueColor 12 Bold
TextStyle blueColor12BoldTextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: purpleColor
);

TextStyle chatTimeTextStyle = TextStyle(
fontFamily: "Roboto",
fontSize: 10,
color: lightGreyColor
);
...
///WhiteColor 12 Bold
TextStyle whiteColor12BoldTextStyle = TextStyle(
  fontFamily: "Roboto",
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: whiteColor
...
TextStyle lightBlueColor12BoldTextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: lightBlueColor
);
///BlackColor 12 Bold
TextStyle blackColor12BoldTextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: blackColor
);
///GreyColor 12 Bold
TextStyle greyColor12BoldTextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: greyColor
);
...
///BlueColor 12 normal
TextStyle blueColor12TextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: purpleColor
);
///whiteColor 12 normal
TextStyle whiteColor12TextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: whiteColor
);
///whiteColor 14 normal
TextStyle whiteColor14TextStyle = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: whiteColor
);
///BlackColor 12 normal
TextStyle blackColor12TextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: blackColor
);
///GreyColor 12 normal
TextStyle greyColor12TextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: greyColor
);
///GreyColor 14 normal
TextStyle greyColor14TextStyle = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: greyColor
);
///GreyColor 14 normal
TextStyle greyColor14BoldTextStyle = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w900,
    color: greyColor
);
///RedColor 12 normal
TextStyle redColor12TextStyle = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: redColor
);
